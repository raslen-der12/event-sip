...
import "./event-speaker-quick.css";
import imageLink from "../../../utils/imageLink";

/**
 * Modal quick-view for a single speaker.
 * Keyboard: Esc closes, ←/→ navigate (when handlers provided).
 */
export default function EventSpeakerQuickView({
  open = false,
  item = null,
  index = 0,
  total = 0,
  ...
  return (
    <div className="esq-overlay" role="dialog" aria-modal="true" aria-label="Speaker preview">
...
EventSpeakerQuickView.propTypes = {
  open: PropTypes.bool,
