...
import "./event-attendees-compare.css";
import imageLink from "../../../utils/imageLink";

/** Bottom drawer with selected attendees (max 3) and simple compare view */
export default function EventAttendeesCompareDrawer({
  items = [],
  onRemove,
  onClear,
  open = false,
  ...
  return (
    <div className="esc-wrap" role="dialog" aria-modal="true" aria-label="Compare attendees">
...
EventAttendeesCompareDrawer.propTypes = {
